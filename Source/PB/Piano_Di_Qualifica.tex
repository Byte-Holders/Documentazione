...
\subsubsection*{PB}
Nella fase di Product Baseline, il Time Estimate At Completion (TEAC) consolida in modo netto il proprio trend decrescente. Dallo Sprint\textsuperscript{G} 7 in avanti, l'indicatore si riduce con regolarità fino a convergere in modo esatto con la durata pianificata durante lo Sprint\textsuperscript{G} 12. In sintesi, il team ha riassorbito integralmente il ritardo temporale accumulato nella fase iniziale, chiudendo il progetto nel pieno rispetto delle tempistiche originarie.
\newpage
