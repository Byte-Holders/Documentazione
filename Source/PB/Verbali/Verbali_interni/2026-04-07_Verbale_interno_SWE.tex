...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{3cm} >{\raggedright\arraybackslash}p{6cm} >{\centering\arraybackslash}p{3.5cm}}
        ...
        AZ-PB-025 & stesura mdoulo Workspace del documento di Specifica Tecnica & Giulia Romanato, Damiano Berti, Giacomo Nalotto \\
        AZ-PB-025 & stesura mdoulo Workspace del documento di Specifica Tecnica & Giulia Romanato, Damiano Berti, Giacomo Nalotto \\
        ...
        AZ-PB-026 & stesura modulo Scan del documento di Specifica Tecnica & Alessandro Frison \\
        AZ-PB-026 & stesura modulo Repository del documento di Specifica Tecnica & Giacomo Nalotto \\
    \end{tabular}
\end{center}
\end{document}