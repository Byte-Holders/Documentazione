...
\begin{center}
	...
	\begin{tabular}{>{\centering\arraybackslash}m{1.5cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
		...
		0.13.0 & 12/02/2026 & Giulia Romanato & Cambio numero: (UC37->UC15, UC38->UC16, UC39->UC17) e unificato dtile delle subsubsection \\
...
\begin{itemize}
    ...
    \begin{enumerate}
    \item Il sistema recupera la lista dei ruoli disponibili nel workspace
    \item Il sistema mostra una lista con i ruoli disponibili
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è attivo e funzionante
        \item L'utente è stato riconosciuto dal sistema come Utente
        \item L'utente sta visualizzando la sezione di analisi dei test unitari(\hyperref[UC33.1]{UC33.1})
        \item L'analisi della qualità dei test è stata eseguita con successo
    \end{itemize}
    \item \textbf{Postcondizioni:}
    \begin{itemize}
        \item Viene visualizzato l'elenco dei test unitari che presentano problemi di qualità
    \end{itemize}
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema recupera l'elenco dei test che superano le soglie di tolleranza definite
        \item Il sistema elenca i test unitari con qualità insufficiente, indicando per ciascuno:
        \begin{itemize}
            \item Nome del test
...
\subparagraph{UC33.3.2.1 - Visualizzazione elenco vulnerabilità riscontrate}\label{UC33.3.2.1}
\begin{itemize}
    \item \textbf{Attori principali:}
    \begin{itemize}
        \item Tech Lead
