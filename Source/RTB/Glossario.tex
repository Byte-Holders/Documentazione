...
\begin{longtable}{>{\centering\arraybackslash}p{1.35cm} >{\centering\arraybackslash}p{1.8cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}p{5cm}}
	...
	0.7.0 & 24/02/2026 & Alessandro Morabito & Giulia Romanato & Aggiunti: Attore, Casi d'uso, Norme di Progetto, Owner, Piano di Progetto, Piano di Qualifica, Scenario.\\
	0.6.0 & 22/02/2026 & Alessandro Morabito & Giulia Romanato & Aggiunti: Code Coverage, Langchain, Langgraph, LLM, MongoDB, PoC, Report, SBOM, semgrep, syft.\\
...
\term{CVSS}
\textit{Common Vulnerability Scoring System}. Una metrica che associa un valore numerico compreso tra 0 (bassa gravità) e 10 (alta gravità) a una determinata vulnerabilità. A un valore numerico è associata anche una stringa (\textit{CVSS vector string}) che specifica i valori utilizzati per ottenerlo. Attualmente in versione \texttt{4.0}\footnote{Specifica CVSSv4.0: \url{https://www.first.org/cvss/v4.0/specification-document}}.
