...
\begin{center}
	...
	\begin{tabular}{>{\centering\arraybackslash}m{1.5cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
		...
		0.12.0 & 11/02/2026 & Giulia Romanato & Cambio numero: (UC37->UC15, UC38->UC16, UC39->UC17) e unificato dtile delle subsubsection \\
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \textbf{Condizione:} l'orchestratore non riesce a comunicare con le GitHub per recuperare la data dell'ultimo push
			\item \textbf{Flusso:}
			\begin{enumerate}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Si è verificato un errore di comunicazione con le GitHub
	\end{itemize}
	\item \textbf{Postcondizioni:}
	\begin{itemize}
	...
	\item \textbf{Scenario principale:}
	\begin{enumerate}
		\item L'orchestratore rileva un errore durante la comunicazione con le GitHub
...
\subsubsection{UC 15 - Avvia scansione}
...
\paragraph{UC 15.1 - Scansione workspace} \label{UC15.1}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:}
	\begin{itemize}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Il sistema esegue l'analisi (\hyperref[UC17]{UC17 - Esegui analisi})
	\end{enumerate}
	\item \textbf{Inclusioni}: \hyperref[UC35]{UC35}, \hyperref[UC17]{UC17}
	\item \textbf{Eredita da}: \hyperref[UC15]{UC15 - Avvia scansione}
\end{itemize}
...
\subsubsection{UC17 - Esegui analisi repository} \label{UC17}
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{Errore durante l'analisi di un agente:} 
			...
			\end{itemize}
	\end{itemize}
	\item \textbf{Inclusioni:} \hyperref[UC17.1]{UC17.1}, \hyperref[UC17.2]{UC17.2}, \hyperref[UC17.3]{UC27.3}, \hyperref[UC17.4]{UC17.4}
\end{itemize}
...
\paragraph{UC 25.1 - Visualizza nome repository}\label{UC25.1}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 25.2 - Visualizza data ultima scansione} \label{UC25.2}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 25.3 - Visualizza presenza criticità} \label{UC25.3}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 25.4 - Visualizza voto documentazione} \label{UC25.4}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 25.5 - Visualizza percentuale test coverage} \label{UC25.5}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 26.1 - Inserisci link repository GitHub}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 26.2 - Inserisci PAT repository GitHub}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
		...
		\item \textbf{Repository appartenente a più workspace}
			\begin{itemize}
				...
				\begin{enumerate}
					...
					\end{itemize}
					\item cbLa repository e i relativi dati restano disponibili negli altri workspace
				\end{enumerate}
			\end{itemize}
	\end{itemize}
