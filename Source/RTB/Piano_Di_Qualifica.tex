...
In questa sezione elenchiamo i test necessari per verificare che il software funzioni correttamente nel suo insieme. L'obiettivo è dimostrare che tutti i requisiti (funzionali e prestazionali) definiti nell'Analisi dei Requisiti\textsuperscript{G} v2.0.0 sono stati soddisfatti prima della consegna.
...
TS-27 & Verificare che il sistema recuperare la data dell'ultimo push da GitHub\textsuperscript{G} per verificare l'aggiornamento & R-27-F-De & NI \\
TS-28 & Verificare che il sistema aggiornare lo stato della repository a 'non aggiornata' se il push è più recente della scansione & R-28-F-De & NI \\
...
TS-41 & Verificare che ciascun agente esegua l'analisi di competenza e generare un report\textsuperscript{G} parziale & R-41-F-Ob & NI \\
...
TS-54 & Verificare che il sistema validi il link della repository e verificare l'accesso & R-54-F-Ob & NI \\
...
TS-57 & Verificare che il sistema avvisi l'utente se la repository da rimuovere ha scansioni in corso e richiedere conferma esplicita & R-57-F-Ob & NI \\
