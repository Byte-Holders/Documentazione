...
\begin{table}[h]
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{1.4cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.2cm} >{\raggedright\arraybackslash}m{2.2cm} >{\raggedright\arraybackslash}m{5.8cm}}
        ...
        1.0.0 & 24/02/2026 & Alessandro Frison & Lorenzo Grolla & Versione finale del documento, con tutte le sezioni completate e revisionate. \\
...
\begin{itemize}
    \item \textbf{Glossario\textsuperscript{G}}: \\ \url{https://github.com/Byte-Holders/Documentazione/blob/main/RTB/Glossario.pdf}.
...
\begin{table}[h!]
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{1.5cm} p{6cm} >{\centering\arraybackslash}m{3cm} >{\centering\arraybackslash}m{2.5cm}}
        \rowcolor{AccentColor}
        \textcolor{white}{\textbf{ID}} & \textcolor{white}{\textbf{Nome}} & \textcolor{white}{\textbf{Accettabile}} & \textcolor{white}{\textbf{Ottimo}} \\
        MPD-05 & \textbf{Condition Coverage } & $\geq 60\%$ & $100\%$ \\
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{1.5cm} p{6cm} >{\centering\arraybackslash}m{3cm} >{\centering\arraybackslash}m{2.5cm}}
        \rowcolor{AccentColor}
        \textcolor{white}{\textbf{ID}} & \textcolor{white}{\textbf{Nome}} & \textcolor{white}{\textbf{Accettabile}} & \textcolor{white}{\textbf{Ottimo}} \\
        MPD-06 & \textbf{Response Time} & $\leq 10s$ & $\leq 4s$ \\
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{1.5cm} p{6cm} >{\centering\arraybackslash}m{3cm} >{\centering\arraybackslash}m{2.5cm}}
        \rowcolor{AccentColor}
        \textcolor{white}{\textbf{ID}} & \textcolor{white}{\textbf{Nome}} & \textcolor{white}{\textbf{Accettabile}} & \textcolor{white}{\textbf{Ottimo}} \\
        MPD-07 & \textbf{Facilità di utilizzo} & $\leq 7$ click & $\leq 5$ click\\
        MPD-08 & \textbf{Tempo medio di apprendimento} & $\leq 5$ minuti & $\leq 2$ minuti\\
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{1.5cm} p{6cm} >{\centering\arraybackslash}m{3cm} >{\centering\arraybackslash}m{2.5cm}}
        \rowcolor{AccentColor}
        \textcolor{white}{\textbf{ID}} & \textcolor{white}{\textbf{Nome}} & \textcolor{white}{\textbf{Accettabile}} & \textcolor{white}{\textbf{Ottimo}} \\
        MPD-09 & \textbf{Accoppiamento Moduli} & $\leq 4$ & $\leq 2$ \\
        MPD-10 & \textbf{Linee per Metodo} & $\leq 30$ & $\leq 15$ \\
        MPD-11 & \textbf{Parametri per Metodo} & $\leq 4$ & $\leq 2$ \\
        MPD-12 & \textbf{Attributi per Classe} & $\leq 7$ & $\leq 5$ \\
        MPD-13 & \textbf{Structure Fan-In} & - & massimizzato \\
        MPD-14 & \textbf{Structure Fan-Out} & - & minimizzato \\
    \end{tabular}
...
In questa sezione elenchiamo i test necessari per verificare che il software funzioni correttamente nel suo insieme. L'obiettivo è dimostrare che tutti i requisiti (funzionali e prestazionali) definiti nell'Analisi dei Requisiti\textsuperscript{G} v1.0.0 sono stati soddisfatti prima della consegna.
...
TS-06 & Verificare che il sistema autentichi gli utenti tramite Amazon Cognito\textsuperscript{G} & R-6-F-Ob & NI \\
...
TS-11 & Verificare che l'utente possa visualizzare la lista degli inviti ricevuti con dettagli (mittente, owner\textsuperscript{G}, nome workspace) & R-11-F-Ob & NI \\
...
TS-15 & Verificare che il Project Manager\textsuperscript{G} possa rimuovere un utente da un workspace & R-15-F-Ob & NI \\
TS-16 & Verificare che il sistema verifichi automaticamente lo stato di aggiornamento di una repository & R-16-F-De & NI \\

% === Tag raccolta ===
TS-17 & Verificare che l'utente possa visualizzare la lista dei tag\textsuperscript{G} raccolta\textsuperscript{G} di un workspace & R-17-F-De & NI \\
TS-18 & Verificare che l'utente possa creare un tag\textsuperscript{G} raccolta\textsuperscript{G} all'interno di un workspace & R-18-F-De & NI \\
TS-19 & Verificare che l'utente possa eliminare un tag\textsuperscript{G} raccolta\textsuperscript{G} dal workspace & R-19-F-De & NI \\
TS-20 & Verificare che l'utente possa assegnare tag\textsuperscript{G} raccolta\textsuperscript{G} a una repository & R-20-F-De & NI \\
TS-21 & Verificare che l'utente possa rimuovere tag\textsuperscript{G} raccolta\textsuperscript{G} da una repository & R-21-F-De & NI \\

% === Repository ===
TS-22 & Verificare che l'utente possa visualizzare la lista delle repository del workspace & R-22-F-Ob & NI \\
TS-23 & Verificare che l'utente possa aggiungere una repository GitHub\textsuperscript{G} al workspace & R-23-F-Ob & NI \\
...
TS-31 & Verificare che il sistema permetta la selezione del branch\textsuperscript{G} per la visualizzazione & R-31-F-Ob & NI \\
...
TS-39 & Verificare che il sistema mostri la lista dei framework\textsuperscript{G} rilevati & R-39-F-Ob & NI \\

% === Analisi sicurezza OWASP ===
TS-40 & Verificare che il sistema mostri grafici semplificati dei risultati OWASP & R-40-F-Ob & NI \\
TS-41 & Verificare che il sistema mostri un elenco ordinato delle vulnerabilità\textsuperscript{G} OWASP & R-41-F-Ob & NI \\
TS-42 & Verificare che il sistema fornisca i dettagli per ogni vulnerabilità\textsuperscript{G} & R-42-F-De & NI \\
...
TS-52 & Verificare che l'utente possa filtrare la visione aggregata per tag\textsuperscript{G} raccolta\textsuperscript{G} & R-52-F-De & NI \\
...
TS-56 & Verificare che il sistema salvi un report\textsuperscript{G} finale dell'analisi & R-56-F-Ob & NI \\

% === Requisiti Opzionali ===
TS-57 & Verificare l'integrazione con CI/CD (GitHub\textsuperscript{G} Actions\textsuperscript{G}) & R-57-F-Op & NI \\
...
TA-11 & Verificare che il prodotto permetta l'aggiunta di repository GitHub\textsuperscript{G} a un workspace con validazione del link & NI \\
...
TA-14 & Verificare che il prodotto permetta la gestione dei tag\textsuperscript{G} raccolta\textsuperscript{G} (creazione, assegnazione, rimozione, eliminazione) & NI \\
TA-15 & Verificare che il prodotto permetta la visualizzazione del dettaglio di una repository con selezione del branch\textsuperscript{G} & NI \\
...
TA-18 & Verificare che il prodotto mostri i risultati dell'analisi della qualità del codice (test coverage, linguaggi, librerie, framework\textsuperscript{G}) & NI \\
TA-19 & Verificare che il prodotto mostri i risultati dell'analisi di sicurezza OWASP (grafici, elenco vulnerabilità\textsuperscript{G}, dettagli) & NI \\
...
TA-22 & Verificare che il prodotto permetta la visualizzazione di una visione aggregata del workspace con filtro per tag\textsuperscript{G} & NI \\
TA-23 & Verificare che il prodotto distribuisca l'analisi tra agenti specializzati coordinati dall'orchestratore & NI \\
TA-24 & Verificare che il prodotto aggreghi i risultati e salvi un report\textsuperscript{G} finale delle analisi & NI \\
...
\subsection{Sprint Goal Achivement (MPC-15)}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Assets/pdq/SGA.png}
    \caption{Andamento dello Sprint Goal Achivement}
