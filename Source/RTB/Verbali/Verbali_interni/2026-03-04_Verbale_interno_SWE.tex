...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
        ...
        1.0.0 & 04/03/2026 & Lorenzo Grolla & Approvazione del verbale \\
        0.1.0 & 04/03/2026 & Alessandro Morabito & Verifica del verbale \\
...
Durante la fase di retrospettiva si è discusso riguardo alla presentazione dell'RTB al professor Cardin, avvenuta il 27/02/2026, in merito a eventuali migliorie da apportare considerando i suggerimenti del professore in attesa di un suo riscontro finale.


\subsubsection{Discussione sul prossimo Sprint}
Durante la riunione sono emerse le seguenti riflessioni relativamente al prossimo sprint:
\begin{itemize}
