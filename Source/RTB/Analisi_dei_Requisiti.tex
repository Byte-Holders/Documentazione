...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{enumerate}
        \end{itemize}
		\item \textbf{Selezione Branch\textsuperscript{G}:}
		\begin{itemize}
			\item \textbf{Condizione:} L'utente vuole cambiare branch\textsuperscript{G} di cui vedere i dettagli
            \item  \textbf{Flusso:}
			\begin{enumerate}
				\item L'utente sceglie il branch\textsuperscript{G} di cui vedere i dettagli tra la lista dei branch\textsuperscript{G} disponibili
			\end{enumerate}
		\end{itemize}
        \item \textbf{Aggiorna visualizzazione (\hyperref[UC37]{UC37 - Aggiorna repository}):}
        \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario\textsuperscript{G} alternativo:}
    \begin{itemize}
        \item \textbf{Filtra per tag\textsuperscript{G} (\hyperref[UC36.1]{UC36.1}):}
        \begin{itemize}
            \item \textbf{Condizione:} L'utente vuole filtrare le repository per tag\textsuperscript{G} 
            \item \textbf{Flusso:}
            \begin{enumerate}
