...
\begin{center}
	...
	\begin{tabular}{>{\centering\arraybackslash}m{1.5cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
        ...
        0.15.0 & 13/02/2026 & Giulia Romanato & Inserito UC25.1 Visualizza singolo elemento lista repository del workspace, sitemati grafici, cambiato numero Aggiorna repository (UC33->UC37) e aggiunta Aggiorna repository come extend a UC35, UC33, UC36\\
...
\paragraph{UC 25.1.1 - Visualizza nome repository}\label{UC25.1.1}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\subsection{UC29 - Ricerca repository}\label{UC29}
...
\subsection{UC30 - Ricerca con barra}\label{UC30}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\subsection{UC31 - Ricerca con filtri}\label{UC31}
...
\subsection{UC32 - Ordinamento lista repository}\label{UC32}
...
\subparagraph{UC33.3 - Visualizzazione analisi sicurezza semplice}\label{UC33.3}
...
\subparagraph{UC33.4 - Visualizzazione analisi sicurezza completa}\label{UC33.4}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{../Assets/AdR/UC33-4.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{../Assets/AdR/UC33-5.png}
...
\begin{itemize}
    ...
    \end{enumerate}
    \item \textbf{Inclusioni:} \hyperref[UC33.5.1]{UC33.5.1}, \hyperref[UC33.4.2]{UC33.5.2}, \hyperref[UC33.4.3]{UC33.5.3}
\end{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{../Assets/AdR/UC33-6.png}
...
\begin{itemize}
    \item \textbf{X}: nmero progressivo del requisito
...
\begin{longtable}[c]{ c p{8.3cm} c }
    ...
    R-29-F-Ob & L'utente deve poter aggiornare le informazioni sulle repository in base all'ultima scansione & UC Aggiorna \\
    ...
    R-57-F-Op & Integrazione con CI/CD (GitHub Actions) & Capitolato N2H \\
    R-58-F-Op & Analisi storica e confronto tra versioni & Capitolato N2H \\
    R-59-F-Op & Ranking dei progetti per qualità complessiva & Capitolato N2H \\
    R-60-F-Op & Remediation interattiva con anteprima & Capitolato N2H \\
    R-61-F-Op & Notifiche integrate (Slack/Teams/Email) & Capitolato N2H \\
    R-62-F-Op & Plugin system per nuovi agenti di analisi & Capitolato N2H \\
\end{longtable}
...
\begin{longtable}{ c p{9cm} c }
    ...
    R-9-V-Ob & Architettura ad agenti coordinati da un orchestratore autocratico & Capitolato, \hyperref[UC39]{UC39} \\
\end{longtable}
