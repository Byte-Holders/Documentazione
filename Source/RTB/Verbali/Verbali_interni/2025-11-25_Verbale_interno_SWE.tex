...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
        ...
        0.1.0 & 27/11/2025 & Lorenzo Grolla &  Verifica e correzzione refusi del verbale\\
...
All’inizio della riunione il gruppo ha discusso su come organizzare la stesura del documento di analisi dei requisiti, decidendo come prima cosa di concentrarsi sui casi d’uso. Il gruppo ha quindi avviato il processo di individuazione degli attori, partendo dal materiale elaborato nella prima sessione di design thinking con l’azienda proponente.
\\
Il tempo a disposizione non è però stato sufficiente per allineare le idee di tutti i membri sul ruolo degli attori “Tech Lead” e “Project Manager”, quindi si è deciso che ciascun membro rifletterà sull’argomento e che la decisione definitiva verrà presa nella prossima riunione.
