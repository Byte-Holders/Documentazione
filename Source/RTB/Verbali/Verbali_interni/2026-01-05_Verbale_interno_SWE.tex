    ...
    \begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
        \rowcolor{AccentColor}
          ...
          \multicolumn{1}{c}{\textcolor{white}{\textbf{Descrizione delle modifiche}}} \\
            1.0.0 & --/01/2026 & Damiano Berti & Approvazione del verbale \\
            0.1.0 & --/01/2026 & ---- & Verifica del verbale \\ 
...
\\
Dopo un'attenta analisi delle attività rimanetnti per poter consegnare l'RTB, è stato deciso che la consegna avverrà entro la \textbf{prima settimana di febbraio 2026} (2-8 febbraio 2026).\\
...
\\
È stata presa in esame la risposta inviataci dal professore che tuttavia non ha dissolto completamente il dubbio. Quindi è stata richiestra una precisazione in merito alla risposta precedente.
