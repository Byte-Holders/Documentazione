...
\end{itemize}
Per quando riguarda la progettazione del frontend, è confermata in via definitiva la scelta di adottare il model-view-viewmodel (MVVM) come pattern architetturale.
