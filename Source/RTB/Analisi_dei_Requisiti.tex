...
\usepackage{etoolbox}
% Fix "Infinite glue shrinkage" con longtable + xcolor[table]
\makeatletter
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{../Assets/AdR/UC33-1-2.png}
...
\begin{longtable}[c]{
    ...
    >{\centering\arraybackslash}p{8.3cm}
...
\begin{longtable}[c]{ >{\centering\arraybackslash}p{5cm} >{\centering\arraybackslash}p{8.5cm} }
    \rowcolor{AccentDark}
