...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
        ...
        1.0.0 & xx/12/2025 & xxxxxx & Approvazione del verbale \\ 

        0.1.0 & xx/12/2025 & xxxxxx & Verifica del verbale \\ 
...
\\
Infine è stata approvata all'unanimità la struttura definitiva della repository, in particolare le divisione delle varie milestone e delle labels:
\begin{itemize}
...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{3cm} >{\raggedright\arraybackslash}p{7cm} >{\centering\arraybackslash}p{2.5cm}}
        ...
        DEC-RTB-014 & Struttura definitiva della repository & Tutti \\
