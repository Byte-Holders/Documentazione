...
\begin{center}
	...
	\begin{tabular}{>{\centering\arraybackslash}m{1.5cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
		...
		0.14.0 & 13/02/2026 & Giulia Romanato & inserito UC25.1 Visualizza singolo elemento lista repository del workspace, sitemati grafici, cambiato numero Aggiorna repository (UC33->UC37) e aggiunta Aggiorna repository come extend a UC35, UC33, UC36\\
...
\subsubsection{UC 15 - Avvia scansione} \label{UC15}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../Assets/AdR/UC15.png}
...
\begin{itemize}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../Assets/AdR/UC15gen.png}
	\caption{UC15 - Avvia scansione} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../Assets/AdR/UC17.png}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Per ciascuna repository, il sistema visualizza delle informazioni sintetiche (\hyperref[UC 25.1]{UC 25.1})
	\end{enumerate}
	\item \textbf{Scenario alternativo:}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\end{enumerate}
		\end{itemize}
		\item \textbf{Aggiorna visualizzazzione (\hyperref[UC37]{UC37 - Aggiorna repository}):}
        \begin{itemize}
...
\paragraph{UC25.1 - Visualizza singolo elemento lista repository del workspace}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../Assets/AdR/UC25_1.png}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item Il nome della repository (\hyperref[UC 25.1.1]{UC 25.1.1})
			\item La data dell'ultima scansione (\hyperref[UC 25.1.2]{UC 25.1.2})
			\item L'indicatore di presenza criticità (\hyperref[UC 25.1.3]{UC 25.1.3})
			\item Il voto della documentazione (\hyperref[UC 25.1.4]{UC 25.1.4})
			\item La percentuale di test coverage (\hyperref[UC 25.1.5]{UC 25.1.5})
		\end{itemize}
	\end{enumerate}
	\item \textbf{Scenario alternativo:}
	\begin{itemize}
...
\subparagraph{UC 25.1.1 - Visualizza nome repository}\label{UC25.1.1}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 25.1.2 - Visualizza data ultima scansione} \label{UC25.1.2}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 25.1.3 - Visualizza presenza criticità} \label{UC25.1.3}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 25.1.4 - Visualizza voto documentazione} \label{UC25.1.4}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\paragraph{UC 25.1.5 - Visualizza percentuale test coverage} \label{UC25.1.5}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
...
\subsection{UC37 - Aggiorna repository} \label{UC37}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:}
	\begin{itemize}
