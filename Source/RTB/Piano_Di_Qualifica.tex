...
\begin{table}[h]
    ...
    \makebox[\textwidth][c]{ 
        ...
        \begin{tabular}{>{\centering\arraybackslash}m{1,4cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.2cm} >{\raggedright\arraybackslash}m{2.2cm} >{\raggedright\arraybackslash}m{6cm}}
...
In questa sezione elenchiamo i test necessari per verificare che il software funzioni correttamente nel suo insieme. L'obiettivo è dimostrare che tutti i requisiti (funzionali e prestazionali) definiti nell'Analisi dei Requisiti sono stati soddisfatti prima della consegna.\begin{center}
\rowcolors{2}{LightGray}{white}
\renewcommand{\arraystretch}{1.5} 
\begin{longtable}{|>{\centering\arraybackslash}p{1,2cm}|>{\raggedright\arraybackslash}p{9cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{1.2cm}|}
\hline
\rowcolor{AccentColor}
\textcolor{white}{\textbf{ID}} & \textcolor{white}{\textbf{Descrizione}} & \textcolor{white}{\textbf{Requisito}} & \textcolor{white}{\textbf{Stato}} \\
\hline
\endhead
TS-01 & Test di sistema 1(placeholder) & R-1-F & NI \\ \hline

\end{longtable}
\end{center}

\subsection{Test di Accettazione}
Questi test servono a confermare che il prodotto soddisfi le aspettative del cliente e degli utenti finali. Superare questi test garantisce che il software è pronto per l'uso reale e può essere rilasciato ufficialmente.\begin{center}
\rowcolors{2}{LightGray}{white}
\renewcommand{\arraystretch}{1.5} 
...
\hline
\endhead
TA-01 & Test di accettazione 1(placeholder) & NI \\ \hline
...
\begin{figure}[h!]
    ...
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering
        \vspace{3cm}
        \textit{Grafico dell'andamento di AC-ETC(Dati non ancora disponibili)}
        \vspace{3cm}
    \end{minipage}}
...
\begin{figure}[h!]
    ...
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering
        \vspace{3cm}
        \textit{Grafico dell'andamento di CSI-SPI(Dati non ancora disponibili)}
        \vspace{3cm}
    \end{minipage}}
    \caption{Andamento di CSI-SPI}
\end{figure}
...
\begin{figure}[h!]
    ...
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering
        \vspace{3cm}
        \textit{Grafico dell'andamento di EAC(Dati non ancora disponibili)}
        \vspace{3cm}
    \end{minipage}}
...
\begin{figure}[h!]
    ...
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering
        \vspace{3cm}
        \textit{Grafico dell'andamento di RSI(Dati non ancora disponibili)}
        \vspace{3cm}
    \end{minipage}}
...
Monitoraggio della leggibilità della documentazione prodotta (Piano Qualifica, Analisi dei Requisiti, ecc.).
\begin{figure}[h!]
    \centering
    % Placeholder per il grafico
    \fbox{\begin{minipage}{0.8\textwidth}
...
\newpage
\subsection{Correttezza Ortografica (MPC-10)}
...
\begin{figure}[h!]
    ...
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering
        \vspace{3cm}
        \textit{Grafico degli errori ortografici per documento}
        \vspace{3cm}
    \end{minipage}}
