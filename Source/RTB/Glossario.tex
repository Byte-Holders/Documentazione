...
\GlossarioLettera{L}
\term{Langchain}
\refterm{Framework} open source per lo sviluppo di applicazioni basate su \refterm{LLM}. Consente l'utilizzo di workflow semplici.

\term{Langgraph}
\refterm{Framework} open source per lo sviluppo di applicazione basate su \refterm{LLM}. Di basso livello, è concentrato principalmente sull'orchestrazione di agenti. Il workflow è compilato a partire da un grafo, personalizzabile.
