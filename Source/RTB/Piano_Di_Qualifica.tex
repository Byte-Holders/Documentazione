    ...
    \makebox[\textwidth][c]{ 
        ...
        \begin{tabular}{>{\centering\arraybackslash}m{1.4cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.2cm} >{\raggedright\arraybackslash}m{2.2cm} >{\raggedright\arraybackslash}m{6cm}}
            \rowcolor{AccentColor}
              ...
              \multicolumn{1}{>{\columncolor{AccentColor}}c}{\textcolor{white}{\textbf{Autore}}} &
              \multicolumn{1}{>{\columncolor{AccentColor}}c}{\textcolor{white}{\textbf{Verificatore}}} &
              \multicolumn{1}{>{\columncolor{AccentColor}}c}{\textcolor{white}{\textbf{Descrizione delle modifiche}}} \\
...
TS-00 & Verificare che un utente non autenticato possa registrarsi al sistema inserendo username, email e password & R-1-F-Ob & NI \\
