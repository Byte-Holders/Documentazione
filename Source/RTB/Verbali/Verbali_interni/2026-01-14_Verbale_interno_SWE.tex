...
\end{enumerate} 
Nel PoC è stato deciso di non implementare filtri per la selezione delle scansioni da eseguire, non effettuare un'analisi delle best practice e non implementare l'analisi delle librerie.
...
\begin{center}
    ...
    \endhead
        ...
        AZ-RTB-046 & PoC: agente sulla documentazione & Damiano Berti\\
