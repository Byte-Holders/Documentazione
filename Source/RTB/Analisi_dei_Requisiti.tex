...
\begin{center}
	...
	\begin{tabular}{>{\centering\arraybackslash}m{1.5cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
		...
		0.7.0 & 08/02/2026 & Lorenzo Grolla & Stesura UC Verifica aggiornamento scansione \\ 
        0.6.0 & 06/02/2026 & Giacomo Nalotto & Visione analisi sicurezza, analisi documentazione e analisi qualità del codice\\
		0.5.0 & 04/02/2026 & Lorenzo Grolla & Stesura UC Visione Aggregata\\ 
		0.4.0 & 25/01/2026 & Lorenzo Grolla & Stesura UC Dettagli Repository e Selezione Branch\\ 
...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Eredita da}: \hyperref[UC38]{UC38 - Avvio scansione}
\end{itemize}
