...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{../Assets/AdR/Screenshot 2026-02-14 alle 17.51.05.png}
...
\begin{longtable}[c]{ 
    ...
    >{\centering\arraybackslash}m{8.3cm} 
...
\begin{longtable}[c]{ >{\centering\arraybackslash}m{5cm} >{\centering\arraybackslash}m{8.5cm} }
    \rowcolor{AccentDark}
