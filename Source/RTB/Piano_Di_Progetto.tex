...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{1.6cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{1.7cm} >{\raggedright\arraybackslash}m{1.7cm} >{\raggedright\arraybackslash}m{5cm}}
		...
		1.1.0 & 05/03/2026 & Alessandro Morabito & & Redazione sprint 6\\
...
\subsubsubsection{Informazioni generali e attività da svolgere}
Nel quinto sprint gli obiettivi si sono concentrati prevalentemente sulla conclusione dell'Analisi dei Requisiti e del PoC.\\
Gli obiettivi sono:
\begin{itemize}
  \item conclusione dell'analisi dei requisiti
  \item fine sviluppo PoC
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Aggiornamento risorse rimanenti sprint 5}
\end{table}
\subsubsubsection{Rischi incontrati}
\begin{itemize}
  \item I2 - Mancanza di tempo dovuto ad altre attività universitarie
...
Oltre agli impegni accademici, abbiamo incontrato dei punti poco chiari in merito ad alcune sezioni dell'Analisi dei Requisiti.
...
\subsubsubsection{Informazioni generali e attività da svolgere}
Nel sesto sprint ci si è posti come obbiettivo la candidatura alla revisione RTB.\\
Gli obiettivi sono:
\begin{itemize}
	\item finalizzare e ricontrollare documento Analisi dei Requisiti
	\item finalizzare e ricontrollare Proof of Concept
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Aggiornamento risorse rimanenti sprint 6}
\end{table}
\subsubsubsection{Rischi incontrati}
\begin{itemize}
	\item O1 - Sottostima del tempo necessario per una task
...
\begin{enumerate}
	...
	\item la durata dello sprint è stata ridotta da due settimane a una settimana, vista la altrimenti difficile programmazione del singolo sprint.
\end{enumerate}
