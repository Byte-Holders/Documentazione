...
\begin{table}[H]
	...
	\begin{tabular}{|p{.25\linewidth} p{.6\linewidth}|}
		...
		\hline
	\end{tabular}
	\caption{Struttura generale di un caso d'uso}
\end{table}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item La percentuale di code coverage (\hyperref[UC25.1.5]{UC25.1.5})
		\end{itemize}
	\end{enumerate}
	\item \textbf{Scenario alternativo:}
	\begin{itemize}
...
\begin{itemize}
	...
	\begin{enumerate}
		\item Il sistema recupera l'esito dell'ultima analisi della repository
		\item Il sistema calcola o recupera il voto di qualità della documentazione sulla base di criteri quali: presenza del file README, presenza di documentazione tecnica, presenza e qualità dei commenti nel codice, conformità agli standard di documentazione definiti 
...
\paragraph{UC25.1.5 - Visualizza percentuale code coverage} \label{UC25.1.5}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
	\begin{itemize}
	...
	\item \textbf{Postcondizioni:} 
	\begin{itemize}
		\item Viene visualizzato il code coverage della repository
	\end{itemize}
	\item \textbf{Scenario principale:}
	\begin{enumerate}
		\item Il sistema recupera il code coverage calcolato durante l'ultima analisi della repository 
		\item Il sistema mostra il valore percentuale del code coverage
	\end{enumerate}
		\item \textbf{Scenario alternativo:}
	\begin{itemize}
		\item \textbf{Nessun test configurato:} 
			\begin{itemize}
				...
				\item \textbf{Flusso:} 
				\begin{enumerate}
					\item Il sistema mostra il messaggio: “code coverage: 0\% - Nessun test configurato”
				\end{enumerate}
			\end{itemize}
		\item \textbf{Analisi code coverage non disponibile:} 
			\begin{itemize}
				\item \textbf{Condizione:}l'analisi del code coverage non è stata eseguita o non è andata a buon fine
				\item \textbf{Flusso:} 
				\begin{enumerate}
					\item Il sistema mostra il messaggio: “code coverage non disponibile”
				\end{enumerate}
			\end{itemize}
		\item \textbf{Linguaggio non supportato:} 
			\begin{itemize}
				\item \textbf{Condizione:} il linguaggio di programmazione utilizzato nella repository non è supportato per l'analisi del code coverage
				\item \textbf{Flusso:} 
				\begin{enumerate}
					\item Il sistema mostra il messaggio: “Analisi code coverage non supportata per questo linguaggio”
				\end{enumerate}
			\end{itemize}
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item intervallo di code coverage
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item code coverage (crescente, decrescente)
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Il sistema mostra la percentuale di code coverage (\hyperref[UC33.1.1]{UC33.1.1})
...
\subparagraph{UC33.1.1 - Visualizza code coverage}\label{UC33.1.1}
\begin{itemize}
    \item \textbf{Attori principali:} Utente
    \item \textbf{Precondizioni:}
    \begin{itemize}
        ...
        \item L'analisi del code coverage è stata eseguita con successo
    \end{itemize}
    \item \textbf{Postcondizioni:}
    \begin{itemize}
    ...
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema recupera il valore di code coverage calcolato durante l'ultima scansione
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Il sistema visualizza il code coverage medio (\hyperref[UC36.2.1]{UC36.2.1})
        \item Il sistema visualizza il numero di repository con code coverage superiore a soglia (\hyperref[UC36.2.2]{UC36.2.2})
        \item Il sistema visualizza il code coverage minimo (\hyperref[UC36.2.3]{UC36.2.3})
    \end{enumerate}
...
\subparagraph{UC36.2.1 - Visualizza code coverage media}\label{UC36.2.1}
\begin{itemize}
    \item \textbf{Attori principali:} Utente
    \item \textbf{Precondizioni:}
    \begin{itemize}
    ...
    \item \textbf{Postcondizioni:}
    \begin{itemize}
        \item Viene visualizzato il valore medio del code coverage tra le repository del workspace
    \end{itemize}
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema calcola la media del code coverage tra tutte le repository del workspace
        \item Il sistema visualizza il valore percentuale del code coverage medio
    \end{enumerate}
\end{itemize}

% --- UC36.2.2 - code coverage SUPERIORE A SOGLIA ---
\subparagraph{UC36.2.2 - Visualizza code coverage superiore a soglia}\label{UC36.2.2}
\begin{itemize}
    \item \textbf{Attori principali:} Utente
    \item \textbf{Precondizioni:}
    \begin{itemize}
    ...
    \item \textbf{Postcondizioni:}
    \begin{itemize}
        \item Viene visualizzato il numero di repository che hanno un code coverage superiore alla soglia definita
    \end{itemize}
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema conta il numero di repository con code coverage superiore al parametro configurato (default: 70\%)
        \item Il sistema visualizza il conteggio delle repository che superano la soglia
    \end{enumerate}
\end{itemize}

% --- UC36.2.3 - code coverage MINIMO ---
\subparagraph{UC36.2.3 - Visualizza code coverage minimo}\label{UC36.2.3}
\begin{itemize}
    \item \textbf{Attori principali:} Utente
    \item \textbf{Precondizioni:}
    \begin{itemize}
    ...
    \item \textbf{Postcondizioni:}
    \begin{itemize}
        \item Viene visualizzato il valore minimo del code coverage tra le repository del workspace
    \end{itemize}
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema individua il valore minimo di code coverage tra tutte le repository del workspace
        \item Il sistema visualizza il valore percentuale del code coverage minimo
    \end{enumerate}
\end{itemize}
...
\begin{longtable}[c]{ >{\centering\arraybackslash}m{2.5cm} >{\centering\arraybackslash}m{8.3cm} >{\centering\arraybackslash}m{3.5cm} }
    ...
    R-32-F-De & Il sistema deve mostrare la percentuale di code coverage & \hyperref[UC33.1.1]{UC33.1.1} \\
