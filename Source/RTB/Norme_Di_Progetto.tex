...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{1.5cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
        ...
        0.0.11 & 13/01/2026 & Giulia Romanato & Aggiunta sotto sezione 5.1.1 Metodologia, aggiornamento 5.4 Formazione e aggiornamento sezione 4.1.2 Verbali (definizione struttura interna dei verbali, sezione tabella decisioni e azioni diventa sottosezione 4.1.2.1) \\
        0.0.10 & 12/01/2026 & Giulia Romanato & Aggiunta sotto sezione 5.7 Formazione e 5.5 Gestione delle infrastutture e degli strumenti \\
        0.0.9 & 12/01/2026 & Nicolò Lattanzio & Aggiunta sezione Metriche di Qualità del processo e prodotto, e completamento sezione 3.2 Processi di Sviluppo.\\
        0.0.8 & 11/01/2026 & Giulia Romanato & Aggiunta sotto sezione 3.4 rapporto con proponente e 3.5 rapporto col committente e aggiunta del norme di progetto, verbale, dichiarazione di impegni e dichiarazione degli impegni nella sezione 3.1.1 Documenti Principali\\ 
...
\begin{itemize}
    ...
    \item Analisi specifica sulle pull request per valutare la qualità del codice proposto \textcolor{red}{non abbiamo deciso se farlo}
...
\begin{itemize}
    \item \textbf{Processo di Fornitura:} Si occupa della gestione delle relazioni con il committente \textcolor{red}{e il proponente}, dalla risposta alla richiesta iniziale fino alla consegna del prodotto.
...
Questo processo definisce le attività che il gruppo Byte Holders, in qualità di fornitore, implementa per garantire la corretta fornitura del prodotto software a VarGroup S.r.l.,\textcolor{red}{proponente} del progetto\textcolor{red}{, ai docenti Vardanega e Cardin, committenti del progetto} 
...
\begin{enumerate}
    \item \textbf{Risposta al Bando:} Analisi del capitolato \textcolor{red}{presentato dal proponente} e preparazione dell'offerta (documento \textit{Candidatura}).
...
\begin{tcolorbox}[
    ...
    title={Valutazioni Capitolati} % Titolo del box
]
    ...
    Nella Valutazioni Capitolati il gruppo Byte Holders presenta l'obbiettivo, i pregi, i difetti e un resoconto dell'eventuale incontro con l'azienda proponente di ogni capitolato proposto.
\end{tcolorbox}
...
\begin{tcolorbox}[
    ...
    \textbf{\textcolor{AccentDark}{Scopo:}} \\
   Nella Dichiarazione degli Impegni il gruppo Byte Holders presenta una stima dei costi del progetto, a seguito di un approfondito ragionamento riguardo le repsonsabilità dei vari ruoli e all'impegno orario di ogni componente del gruppo. 
