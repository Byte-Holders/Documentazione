...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{../Assets/AdR/UC33ext.png}
...
\begin{itemize}
    \item \textbf{Attori principali:} Utente
    \item \textbf{Precondizioni:} L'utente ha selezionato una repository e un branch valido.
    \item \textbf{Postcondizioni:} L'utente visualizza la dashboard completa della repository.
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema visualizza l'analisi dei test (\hyperref[UC33.1]{UC33.1}).
        \item Il sistema visualizza le informazioni tecniche (\hyperref[UC33.2]{UC33.2}).
        \item Il sistema visualizza l'analisi sicurezza (\hyperref[UC33.3]{UC33.3}).
        \item Il sistema visualizza l'analisi documentazione (\hyperref[UC33.4]{UC33.4}).
        \item Il sistema visualizza la qualità del codice (\hyperref[UC33.5]{UC33.5}).
    \end{enumerate}
    \item \textbf{Inclusioni:} 
    \hyperref[UC33.1]{UC33.1}, \hyperref[UC33.2]{UC33.2}, \hyperref[UC33.3]{UC33.3}, \hyperref[UC33.4]{UC33.4}, \hyperref[UC33.5]{UC33.5}
\end{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{../Assets/AdR/UC33-1ext.png}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema recupera i dati dei test dall'ultima scansione.
        \item Il sistema mostra il coverage (\hyperref[UC33.1.1]{UC33.1.1}).
        \item Il sistema mostra i test con qualità insufficiente (\hyperref[UC33.1.2]{UC33.1.2}).
    ...
    \end{enumerate}
    \item \textbf{Scenario alternativo (Estensione):}
    \begin{enumerate}
        \item \textbf{Nessun test rilevato (UC33.1.5):} Se l'ultima scansione non contiene informazioni sui test, il sistema notifica l'assenza di dati.
    \end{enumerate}
...
\begin{itemize}
    \item \textbf{Scenario principale:} Il sistema visualizza la percentuale di copertura del codice.
\end{itemize}

\subparagraph{UC33.1.2 - Visualizza test con qualità insufficiente}\label{UC33.1.2}
\begin{itemize}
    \item \textbf{Scenario principale:} Il sistema elenca i test che superano le soglie di tolleranza (es. durata eccessiva).
\end{itemize}

\subparagraph{UC33.1.3 - Visualizza percentuale test passati}\label{UC33.1.3}
\begin{itemize}
    \item \textbf{Scenario principale:} Il sistema mostra il rapporto percentuale tra test superati e totali.
\end{itemize}

\subparagraph{UC33.1.4 - Visualizza test non passati}\label{UC33.1.4}
\begin{itemize}
    \item \textbf{Scenario principale:} Il sistema mostra l'elenco dei test falliti per permettere l'analisi dell'errore.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema visualizza la lista dei linguaggi (\hyperref[UC33.2.1]{UC33.2.1}).
        \item Il sistema visualizza la lista delle librerie (\hyperref[UC33.2.2]{UC33.2.2}).
        \item Il sistema visualizza la lista dei framework (\hyperref[UC33.2.3]{UC33.2.3}).
    \end{enumerate}
...
\begin{itemize}
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema recupera i linguaggi rilevati.
        \item Per ogni linguaggio, visualizza il dettaglio (\hyperref[UC33.2.1.1]{UC33.2.1.1}).
    \end{enumerate}
    \item \textbf{Scenario alternativo (Estensione):}
    \begin{enumerate}
        \item \textbf{Nessun linguaggio rilevato (UC33.2.1.3):} Se la scansione non ha rilevato linguaggi, viene mostrato un messaggio apposito.
    \end{enumerate}
...
\end{figure}
\begin{itemize}
    \item \textbf{Scenario principale:} Il sistema mostra i dettagli del singolo linguaggio:
    \begin{itemize}
        \item \textbf{Visualizza nome linguaggio (UC33.2.1.1.1)}
        \item \textbf{Visualizza versione linguaggio (UC33.2.1.1.2)}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema recupera le librerie rilevate.
        \item Per ogni libreria, visualizza il dettaglio (\hyperref[UC33.2.2.1]{UC33.2.2.1}).
    \end{enumerate}
    \item \textbf{Scenario alternativo (Estensione):}
    \begin{enumerate}
        \item \textbf{Nessuna libreria rilevata (UC33.2.2.3):} Se la scansione non ha trovato librerie, viene notificato all'utente.
    \end{enumerate}
...
\end{figure}
\begin{itemize}
    \item \textbf{Scenario principale:} Il sistema mostra i dettagli della singola libreria:
    \begin{itemize}
        \item \textbf{Visualizza nome libreria (UC33.2.2.1.1)}
        \item \textbf{Visualizza versione libreria (UC33.2.2.1.2)}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Scenario principale:}
    \begin{enumerate}
        \item Il sistema recupera i framework rilevati.
        \item Per ogni framework, visualizza il dettaglio (\hyperref[UC33.2.3.1]{UC33.2.3.1}).
    \end{enumerate}
    \item \textbf{Scenario alternativo (Estensione):}
    \begin{enumerate}
        \item \textbf{Nessun framework rilevato (UC33.2.3.3):} Se la scansione non ha rilevato framework, viene mostrato un messaggio di avviso.
    \end{enumerate}
...
\end{figure}
\begin{itemize}
    \item \textbf{Scenario principale:} Il sistema mostra i dettagli del singolo framework:
    \begin{itemize}
        \item \textbf{Visualizza nome framework (UC33.2.3.1.1)}
        \item \textbf{Visualizza versione framework (UC33.2.3.1.2)}
    \end{itemize}
\end{itemize}
