...
\begin{figure}
    ...
    Verificatore & \sffamily Alessandro Morabito, Damiano Berti, Giacomo Nalotto \\
    \arrayrulecolor{MediumGray}\hline \\[-1.5ex] 
...
\begin{longtable}{>{\centering\arraybackslash}p{1.35cm} >{\centering\arraybackslash}p{1.8cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}p{5cm}}
    ...
    2.0.0 & 29/04/2026 & Nicolò Lattanzio & Alessandro Morabito & Versione finale del documento, con modifica alla gestione degli sprint e aggiunta documenti principali PB. \\
    1.1.0 & 09/03/2026 & Alessandro Frison & Lorenzo Grolla & Sistemate metriche del piano di qualifica. \\
    1.0.1 & 09/03/2026 & Nicolò Lattanzio & Lorenzo Grolla & Correzioni ortografiche e modifiche minori. \\
    1.0.0 & 22/02/2026 & Nicolò Lattanzio & Alessandro Morabito & Versione finale del documento, con tutte le sezioni completate e revisionate. \\
    0.11.3 & 12/02/2026 & Nicolò Lattanzio & Damiano Berti & Correzione ortografiche varie e modifiche minori. \\
    0.11.2 & 15/01/2026 & Lorenzo Grolla & Alessandro Frison & Sistemata sezione Metriche di Qualità del Processo \\
    0.11.1 & 15/01/2026 & Alessandro Frison & Lorenzo Grolla & Sistemata sezione Metriche e standard di Qualità e Metriche di Qualità del Prodotto \\
    ...
    0.8.0 & 11/01/2026 & Giulia Romanato & Alessandro Morabito & Aggiunta sotto sezione 3.4 rapporto con proponente e 3.5 rapporto col committente e aggiunta del norme di progetto\textsuperscript{G}, verbale, dichiarazione di impegni e dichiarazione degli impegni nella sezione 3.1.1 Documenti Principali\\ 
...
Questo documento definisce le norme di progetto\textsuperscript{G} adottate dal gruppo \textbf{\textit{BYTE HOLDERS}} per la gestione e lo sviluppo del progetto. Esso stabilisce le linee guida per la documentazione\textsuperscript{G}, la comunicazione, la gestione delle versioni e le responsabilità dei membri del team.
\\
...
\begin{itemize}
    ...
    \item \textbf{Processi Organizzativi}: Processi necessari a creare l'ambiente\textsuperscript{G} e le risorse necessarie affinché i processi primari possano esistere.
\end{itemize}


\subsection{Scopo del prodotto}
Il prodotto sviluppato dal gruppo \textbf{\textit{BYTE HOLDERS}} è un'applicazione web che mira a fornire una piattaforma intuitiva per la gestione delle repository GitHub\textsuperscript{G}, 
...
\begin{itemize}
    ...
    \item Analisi della qualità della documentazione\textsuperscript{G}
    \item Analisi OWASP per la verifica delle vulnerabilità\textsuperscript{G} di sicurezza tramite l'integrazione di strumenti di terze parti
    \item Integrazione con API\textsuperscript{G} di GitHub\textsuperscript{G} per fornire statistiche dettagliate sulle repository
    \item Proposte di remediation per migliorare la qualità del codice e della documentazione\textsuperscript{G}
\end{itemize}
...
\begin{tcolorbox}[
   ...
   Inoltre viene proposta una data di consegna finale del progetto. 
\end{tcolorbox}
...
\begin{tcolorbox}[
    ...
    boxrule=0.5mm,           % Spessore bordo
    arc=2mm,                 % Angoli leggermente arrotondati
    title={Analisi Dei Requisiti\textsuperscript{G}} % Titolo del box
]
    ...
    \textbf{\textcolor{AccentDark}{Scopo:}} \\
    Nell'analisi dei requisiti\textsuperscript{G} il gruppo Byte Holders si impegna a raccogliere, analizzare e documentare i requisiti funzionali e non funzionali del sistema richiesto dal committente VarGroup S.r.l.
...
\begin{tcolorbox}[
    ...
    boxrule=0.5mm,           % Spessore bordo
    arc=2mm,                 % Angoli leggermente arrotondati
    title={Glossario\textsuperscript{G}} % Titolo del box
]
    \textbf{\textcolor{AccentDark}{Autore:}} Analista  %Ruolo che scrive il documento
    ...
    \textbf{\textcolor{AccentDark}{Scopo:}} \\
    Nel glossario\textsuperscript{G} il gruppo Byte Holders si impegna a definire e spiegare i termini tecnici, acronimi e abbreviazioni utilizzati nel contesto del progetto richiesto dal committente VarGroup S.r.l., al fine di garantire una comprensione comune tra tutti gli stakeholder coinvolti.
\end{tcolorbox}
...
\begin{tcolorbox}[
    ...
    boxrule=0.5mm,           % Spessore bordo
    arc=2mm,                 % Angoli leggermente arrotondati
    title={Piano di Progetto\textsuperscript{G}} % Titolo del box
]
    \textbf{\textcolor{AccentDark}{Autore:}} Responsabile  %Ruolo che scrive il documento
    ...
    \textbf{\textcolor{AccentDark}{Scopo:}} \\
    Nel Piano di Progetto\textsuperscript{G} il gruppo Byte Holders si impegna a definire le strategie, le risorse e le tempistiche necessarie per la realizzazione del progetto richiesto dal committente VarGroup S.r.l. garantendo il rispetto degli standard qualitativi e dei vincoli contrattuali.
...
\begin{tcolorbox}[
    ...
    boxrule=0.5mm,           % Spessore bordo
    arc=2mm,                 % Angoli leggermente arrotondati
    title={Piano di Qualifica\textsuperscript{G}} % Titolo del box
]
    ...
    \textbf{\textcolor{AccentDark}{Scopo:}} \\
    Nel Piano di Qualifica\textsuperscript{G} il gruppo Byte Holders si impegna a definire le strategie, i criteri e le procedure di verifica e validazione che garantiranno che il prodotto software sviluppato soddisfi i requisiti specificati dal committente VarGroup S.r.l. e rispetti gli standard di qualità concordati.
...
\begin{tcolorbox}[
    ...
    boxrule=0.5mm,           % Spessore bordo
    arc=2mm,                 % Angoli leggermente arrotondati
    title={Norme di Progetto\textsuperscript{G}} % Titolo del box
]
    \textbf{\textcolor{AccentDark}{Autore:}} Amministratore  %Ruolo che scrive il documento
    ...
    \textbf{\textcolor{AccentDark}{Scopo:}} \\
    Nelle Norme di Progetto\textsuperscript{G} il gruppo Byte Holders si impegna a definire il way of working e le procedute implementate dal gruppo per lo svolgimento del progetto.
\end{tcolorbox}
...
\begin{tcolorbox}[
    ...
    \textbf{\textcolor{AccentDark}{Autore:}} Progettista

    \vspace{0.2cm}
    \textbf{\textcolor{AccentDark}{Destinatari:}} Utenti finali del prodotto, VarGroup S.r.l., Professori Tullio Vardanega e Riccardo Cardin

    \vspace{0.2cm}
    \textbf{\textcolor{AccentDark}{Scopo:}} \\
    Il Manuale Utente fornisce una guida completa all'utilizzo del prodotto sviluppato dal gruppo Byte Holders, descrivendo le funzionalità disponibili e le istruzioni per l'uso.
\end{tcolorbox}
...
\begin{tcolorbox}[
    ...
    \vspace{0.2cm}
    \textbf{\textcolor{AccentDark}{Scopo:}} \\
    Le Specifiche Tecniche descrivono in dettaglio l'architettura, le tecnologie adottate e le scelte progettuali effettuate dal gruppo Byte Holders per la realizzazione del prodotto, fornendo una documentazione di riferimento per lo sviluppo e la manutenzione del sistema.
\end{tcolorbox}
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item \textbf{Analisi dei Requisiti\textsuperscript{G}:} Raccolta\textsuperscript{G}, analisi, specifica e validazione dei requisiti con gli stakeholder. Prodotto: \textit{Documento di Analisi dei Requisiti\textsuperscript{G}}.
        ...
        \item \textbf{Costruzione (Implementazione e Codifica):} Scrittura del codice secondo gli standard di progetto e utilizzo di un sistema di versioning (Git\textsuperscript{G}). Prodotto: Codice sorgente e repository.
        ...
        \end{itemize}
    \end{enumerate}
    \item \textbf{Metodologia:} Adotteremo pratiche ibride Agile, con sprint\textsuperscript{G} per lo sviluppo e milestone\textsuperscript{G} formali per le revisioni.
\end{itemize}

\subsubsection{Analisi dei Requisiti}
L'analisi dei requisiti\textsuperscript{G} è una fase cruciale del processo di sviluppo, in cui il gruppo \textbf{\textit{BYTE HOLDERS}} si impegna a comprendere e documentare le esigenze del committente VarGroup S.r.l.
Tale analisi e' reperibile nel documento \textit{Analisi Dei Requisiti\textsuperscript{G}}, che include:
\begin{itemize}
...
Per garantire l'univocità e la facile identificazione delle funzionalità offerte dal sistema, ogni caso d'uso\textsuperscript{G} è identificato da un codice alfanumerico strutturato secondo la seguente sintassi:
...
\begin{itemize}
    ...
    \item \textbf{CodicePadre}: Numero intero progressivo che identifica il caso d'uso\textsuperscript{G} principale (o padre);
    \item \textbf{CodiceFiglio} (Opzionale): Numero intero progressivo che identifica un sotto-caso d'uso\textsuperscript{G} (o figlio) incluso o esteso dal padre.
\end{itemize}

\textbf{Esempi:}
\begin{itemize}
    \item \textit{UC1}: Login (Caso d'uso\textsuperscript{G} principale);
    \item \textit{UC1.1}: Recupero Password (Sotto-caso d'uso\textsuperscript{G} del Login).
\end{itemize}



\subsubsection{Nomenclatura Requisiti}
In conformità con la necessità di tracciabilità dei requisiti (processo di sviluppo software ISO/IEC 12207), ogni requisito\textsuperscript{G} è classificato e identificato tramite un codice univoco che ne esplicita la tipologia e la priorità.
...
\paragraph{Tipologia}
Indica la natura del requisito\textsuperscript{G}:
\begin{itemize}
    ...
    \item \textbf{V}: \textit{Vincolo} - Descrive limitazioni tecniche, normative o progettuali imposte dal committente o dall'ambiente\textsuperscript{G};
...
Definisce la priorità di implementazione del requisito\textsuperscript{G}:
\begin{itemize}
    \item \textbf{O}: \textit{Obbligatorio} (Must have) - Requisito\textsuperscript{G} indispensabile per il funzionamento del sistema o richiesto esplicitamente dal vincolo contrattuale;
    \item \textbf{D}: \textit{Desiderabile} (Should have) - Requisito\textsuperscript{G} che porta valore aggiunto ma la cui assenza non compromette le funzionalità base;
    \item \textbf{F}: \textit{Facoltativo} (Could have/Nice to have) - Requisito\textsuperscript{G} opzionale da implementare solo se le risorse e le tempistiche lo permettono.
\end{itemize}

\paragraph{Codice}
Un numero intero progressivo univoco che identifica il requisito\textsuperscript{G} (spesso gerarchico).

\textbf{Esempi:}
\begin{itemize}
    \item \textit{RFO1}: Requisito\textsuperscript{G} Funzionale Obbligatorio numero 1;
    \item \textit{RQD12}: Requisito\textsuperscript{G} Qualitativo Desiderabile numero 12.
\end{itemize}
...
\end{itemize}
Relativamente al posizionamento dei file all'interno della repository GitHub\textsuperscript{G}, il gruppo \textbf{\textit{BYTE HOLDERS}} ha deciso di adottare la seguente struttura:
\begin{itemize}
    ...
    \item \textbf{Nomenclatura dei file}: I nomi dei file devono essere esplicativi e riflettere chiaramente il loro contenuto o la loro responsabilità. Si adotterà una convenzione coerente con il framework\textsuperscript{G} utilizzato: \textit{PascalCase} per i componenti React\textsuperscript{G} (es. \texttt{UserProfile.tsx}) e \textit{kebab-case} per i file di backend o utility (es. \texttt{user-controller.ts}).
    \item \textbf{File di configurazione}: Tutti i file di configurazione globale dell'ambiente\textsuperscript{G} o dei tool\textsuperscript{G} di sviluppo (es. \texttt{.gitignore}, \texttt{docker\textsuperscript{G}-compose.yml}, file per pipeline CI/CD) devono risiedere nella directory principale (root) della repository o nella root del rispettivo modulo.
...
\begin{itemize}
  ...
  \item \textbf{Draw.io}: per la realizzazione dei diagrammi UML e altre rappresentazioni grafiche necessarie per la realizzazione degli use-case pubblicati nel documento di Analisi Dei Requisiti\textsuperscript{G} e per progettazione del software finale.
\end{itemize}
...
\begin{itemize}
    ...
    \item la possibilità di organizzare degli incontri, principalmente da remoto, su richiesta del fornitore a seguito del quale il gruppo rederrà un verbale esterno 
    \item degli incontri di formazione sulle tecnologie consigliate (backend, AWS\textsuperscript{G}, frontend, introduzione su AI) 
...
\begin{itemize}
    \item la possibilità di richiedere ricevimenti e/o scrivere mail per chiarire dubbi riguardo i documenti da consegnare o per discutere problemi riguardanti i rapporti con la proponente o tra i vari membri del gruppo
...
\begin{itemize}
    \item \textbf{RTB (Requirements and Tecnology Baseline):} in cui si prevede la consegna del documento di Analisi dei Requisiti\textsuperscript{G}, la stesura del Piano di Progetto, Piano di Qualifica\textsuperscript{G}, Norme di Progetto\textsuperscript{G} e Glossario\textsuperscript{G} e la presentazione di un PoC\textsuperscript{G} (proof of Concept\textsuperscript{G}), una demo eseguibile che motivi la scelta delle tecnologie, framework\textsuperscript{G}, librerie adottate e dimotri la loro adeguatezza e interoperatività  
...
La documentazione\textsuperscript{G} del progetto viene gestita utilizzando \textbf{Latex\textsuperscript{G}} e viene archiviata in un repository dedicato su \textbf{GitHub\textsuperscript{G}}. 
\\Ogni documento segue una struttura standardizzata per garantire coerenza e facilità di lettura.

\subsubsection{Struttura dei documenti}

Tutti i documenti formali prodotti dal gruppo seguono una struttura standardizzata per garantire coerenza, professionalità e facilità di consultazione. Il template \textbf{Latex\textsuperscript{G}} utilizzato definisce chiaramente gli elementi che compongono ciascun documento:

\begin{itemize}[itemsep=6pt]
    \item \textbf{Frontespizio:}
    \begin{itemize}[itemsep=4pt]
        \item Logo del gruppo Byte Holders e titolo del progetto
        \item Nome del documento (es. "Norme di Progetto\textsuperscript{G}", "Verbale Interno")
    ...
    \end{itemize}
\end{itemize}
Questa struttura si applica a tutti i tipi di documenti prodotti, tra cui: Verbali(interni ed esterni), Norme di Progetto\textsuperscript{G}, Analisi dei Requisiti\textsuperscript{G}\dots
...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}p{8cm} >{\centering\arraybackslash}p{2.5cm}}
        ...
        DEC-PB-003 & Delineamento dell'analisi dei requisiti\textsuperscript{G} & Tutti \\
        \midrule
        AZ-RTB-001 & Brainstorming Analisi dei requisiti\textsuperscript{G} & Tutti \\
...
\begin{itemize}
    \item Risultati raggiunti e confronto con previsioni all'inizio dello sprint\textsuperscript{G}.
...
Per la documentazione\textsuperscript{G} del progetto il gruppo \textbf{\textit{BYTE HOLDERS}} utilizza i seguenti strumenti:

\begin{itemize}
    \item \textbf{Linguaggio \LaTeX}: adottato come standard per la stesura di documentazione\textsuperscript{G} tecnica; garantisce un'alta qualità tipografica, uniformità stilistica e una gestione avanzata di riferimenti incrociati e bibliografia, separando il contenuto dalla formattazione.
    \item \textbf{Visual Studio Code}: IDE (Integrated Development Environment) utilizzato come editor principale per la scrittura del codice sorgente LaTeX\textsuperscript{G}, scelto per la sua leggerezza, estensibilità e integrazione nativa con i sistemi di controllo versione.
    \item \textbf{LaTeX\textsuperscript{G} Workshop}: estensione per Visual Studio Code che automatizza il processo di compilazione e build dei documenti; fornisce funzionalità di linting (controllo sintattico), intellisense e anteprima PDF sincronizzata (SyncTeX) per un feedback visivo immediato durante la stesura.
\end{itemize}

\subsection{Gestione della configurazione}

L'obiettivo di questa sezione è definire l'approccio del gruppo \textbf{\textit{BYTE HOLDERS}} per la gestione della configurazione della documentazione\textsuperscript{G} di progetto, al fine di garantire coerenza, tracciabilità e controllo delle modifiche.
In questo caso, come specificato nella sezione degli strumenti di supporto, il gruppo utilizza \textbf{GitHub\textsuperscript{G}} come piattaforma principale per il versionamento e la gestione della configurazione dei documenti.
\\
In particolare e' stato deciso di realizzare due repository distinte per l'RTB:
\begin{itemize}
    \item \textbf{Repository Documentazione\textsuperscript{G}:} Contiene tutti i documenti formali del progetto, come Norme di Progetto\textsuperscript{G}, Verbali, Analisi dei Requisiti\textsuperscript{G}, Piano di Progetto\textsuperscript{G} e altri documenti chiave. Ogni documento è organizzato in cartelle specifiche per facilitarne la navigazione. 
    \item \textbf{Repository Codice Sorgente PoC\textsuperscript{G}:} Contiene il codice sorgente della Proof of Concept\textsuperscript{G} (PoC\textsuperscript{G}) sviluppata durante l'RTB. Questa repository include il codice, gli script di build, i file di configurazione e la documentazione\textsuperscript{G} tecnica correlata alla PoC\textsuperscript{G}.
\end{itemize}

\subsubsection{Produzione e archiviazione}
Il gruppo \textbf{\textit{BYTE HOLDERS}} adotta una strategia ben definita per la produzione e l'archiviazione della documentazione\textsuperscript{G} di progetto, al fine di garantire accessibilità, tracciabilità e sicurezza delle informazioni.
La produzione di un documento segue questi passaggi:

\begin{enumerate}
    \item \textbf{Creazione Issue\textsuperscript{G} e Branch\textsuperscript{G} dedicato:} 
    A seguito dell'apertura di una Issue\textsuperscript{G} su GitHub\textsuperscript{G}, viene creato un branch\textsuperscript{G} di lavorazione dedicato che si distacca dal ramo principale (\textit{main}). La nomenclatura del branch\textsuperscript{G} deve seguire rigorosamente la convenzione: \\
    \texttt{azione\_nome\_documento\_data} (es. \texttt{aggiunta\_verbale\_interno\_11\_12\_2025}).

    \item \textbf{Assegnazione e Stesura:} 
    Il membro assegnato alla Issue\textsuperscript{G} lavora localmente sul file \texttt{.tex}. Durante questa fase vengono effettuati commit frequenti sul branch\textsuperscript{G} dedicato per salvare i progressi, utilizzando Visual Studio Code e LaTeX\textsuperscript{G} Workshop per la scrittura e il controllo sintattico in tempo reale.

    \item \textbf{Verifica (Pull Request):} 
    Completata la stesura, viene aperta una \textit{Pull Request} su GitHub\textsuperscript{G}. In questa fase, i verificatori controllano il contenuto (accuratezza e completezza) e la forma (corretta compilazione LaTeX\textsuperscript{G}), segnalando eventuali correzioni direttamente nel codice o nei commenti.

    \item \textbf{Approvazione e Merge:} 
    Superata la fase di verifica, il Responsabile o un membro designato approva il documento e di seguito la Pull Request ed esegue il \textit{merge} (unione) del branch\textsuperscript{G} dedicato nel ramo \textit{main}. A questo punto, il documento aggiornato è considerato ufficiale e viene compilata la versione PDF definitiva per il rilascio.
\end{enumerate}
...
\\
\\
Per la gestione del versionamento, abbiamo deciso di usare uno schema\textsuperscript{G} a tre livelli, X.Y.Z, dove:
\begin{itemize} 
...
Per facilitare la consultazione e la fruizione della documentazione\textsuperscript{G} di progetto, il gruppo \textbf{\textit{BYTE HOLDERS}} ha implementato un sistema di visualizzazione basato su GitHub\textsuperscript{G} Pages.
Questo sistema, inserito nella repository dedicata alla documentazione\textsuperscript{G}, consente di visualizzare tutta la documentazione\textsuperscript{G} presente nel branch\textsuperscript{G} main della repository, sotto forma di pdf.
...
\begin{itemize}
    \item \textbf{GitHub\textsuperscript{G}}: Piattaforma per il versionamento e collaborazione, utilizzata per la gestione del codice sorgente e della documentazione\textsuperscript{G}..
    \item \textbf{GitHub\textsuperscript{G} Pages}: Servizio che permette di pubblicare il contenuto della repository su un sito web statico, utilizzato per visualizzare i documenti in formato PDF, come descritto nel punto 4.2.3.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Controllo di Processo:} Verifica periodica che le attività svolte dai membri del team siano conformi alle procedure descritte nel Piano di Progetto\textsuperscript{G} e nel Piano di Qualifica\textsuperscript{G}.
...
\begin{itemize}
    \item \textbf{Walkthrough e Inspection:} Revisioni interne approfondite sui documenti (Analisi dei Requisiti\textsuperscript{G}, Specifica Tecnica) e sul codice sorgente per identificare anomalie, discrepanze o errori logici prima di procedere alla fase successiva.
    ...
    \item \textbf{Tracciabilità:} Verifica che ogni requisito\textsuperscript{G} software sia correttamente tracciato e coperto nelle fasi di progettazione e implementazione.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Test di Sistema:} Esecuzione del software completo per verificare che rispetti i requisiti funzionali e non funzionali specificati nel documento di Analisi dei Requisiti\textsuperscript{G}.
    ...
    \item \textbf{Validazione Documentale:} Conferma che la documentazione\textsuperscript{G} prodotta (Manuali Utente, Manuali Sviluppatore) sia comprensibile, completa e utilizzabile dal pubblico di destinazione.
\end{itemize}
...
di questa sezione è anche quello di stabilire procedure e metodologie che il team seguirà durante il ciclo di vita del progetto e il processo di miglioramento continuo dei processi.
...
\begin{itemize}
    \item \textbf{Suddivisione in sprint\textsuperscript{G}:} il lavoro è diviso in cicli di durata pari a due settimane, ciascuno caratterizzato da obiettivi definiti e misurabili decisi all'inizio dello sprit, durante la fase finale del progetto è stato necessario rivedere la durata degli sprint riducendola a 1 settimana, data la maggiore disponibilità di tempo da parte dei membri del gruppo e la necessità di una maggiore frequenza di feedback e iterazione.
    \item \textbf{Incontri di aggiornamento:} durante la fase finale del progetto sono stati organizzati incontri di aggiornamento ogni due giorni, con lo scopo di aggiornare tutto il gruppo sul lavoro svolto fino a un dato momento, gli incontri hanno un tempo massimo di durata di 20 minuti, e non devono portare a nuove decisioni o azioni.
    \item \textbf{Gestione delle attività:} i task vengono definiti, pianificati e assegnati tramite le issue\textsuperscript{G} di GitHub\textsuperscript{G}, organizzate all'interno di una dashboard Kanban, che funge da sistema di issue\textsuperscript{G} tracking, supporta la distribuzione delle responsabilità tra i membri del gruppo e aiuta a monitorare l'avanzamento delle attività
    \item \textbf{Revisione iterativa e migliorativa:} al termine di ogni sprint\textsuperscript{G} viene svolta un'attività di retrospettiva finalizzata all'analisi dei risultati, all'individuazione di possibili miglioramenti dei processi adottati e alla pianificazione di eventuali azioni correttive o migliorative da applicare nel sprint\textsuperscript{G} successivo
\end{itemize}
...
Ogni membro del gruppo in ogni Sprint\textsuperscript{G} può assumere diversi ruoli, in base alle attività che dovrà svolgere durante quel periodo. 
L'unico ruolo unico all'interno di uno Sprint\textsuperscript{G} è quello di Responsabile, che viene assegnato ad un membro diverso ad ogni Sprint\textsuperscript{G}.
...
Il responsabile analizzando lo stato di avanzamento del progetto ha il compito di pianificare ed individuare le attività da svolgere 
    ...
    \begin{itemize}
        \item \textbf{Ad inizio sprint\textsuperscript{G}:} definire gli obiettivi dello sprint\textsuperscript{G}, individuare i possibili rischi, suddividere le attività 
        e assegnarle ai membri del gruppo, controllando che ad ogni membro sia assegnato un numero coerente di ore per ogni ruolo in base ai compiti che dovrà svolgere
        \item \textbf{Durante lo sprint\textsuperscript{G}:} dovrà assicurarsi che le attività vengano svolte nei tempi previsti, monitorare i rischi individuati, cercando di risolvere 
        eventuali problemi che dovessero sorgere, e gestire le comunicazioni con l'azienda proponente
        \item \textbf{A fine sprint\textsuperscript{G}:} guidare l'attività di retrospettiva dello sprint\textsuperscript{G}, capendo le difficoltà riscontrati e cercando di trovare una possibile soluzione, inoltre
          verifica che gli obiettivi siano stati raggiunti
        \item \textbf{Redazione piano di progetto\textsuperscript{G}:} dovrà redigere e aggiornare il piano di progetto\textsuperscript{G} con gli obbiettivi, le ore preventivate, i rischi attesi, le ore effettive,
          i rischi incontrati e le osservazioni uscite durante la retrospettiva dello sprint\textsuperscript{G}, inoltre si occupa della gestione dei rischi 
        ...
        o di approvare i verbali e verificare il glossario\textsuperscript{G} e le norme di progetto\textsuperscript{G} 
    \end{itemize}

\paragraph{Amministratore}
L'Amministratore si occupa di gestire e migliorare l'ambiente\textsuperscript{G} di lavoro, ovvero si occupa tenere aggiornati e migliorare l'infrastruttura tecnologica e organizzativa 
(gli strumenti di sviluppo, verifica e validazione, i sistemi di archiviazione e versionamento della documentazione\textsuperscript{G} e del codice). \\
Le attività che l'amministratore svolge sono:
    \begin{itemize}
        \item \textbf{Redazione norme di progetto\textsuperscript{G}:} si occupa di redigere e aggiornare le norme di progetto\textsuperscript{G}, in modo da garantire che tutti i membri del gruppo seguano le stesse regole e procedure.
        \item \textbf{Redazione piano di qualifica\textsuperscript{G}:} si occupa di redigere e aggiornare il piano di qualifica\textsuperscript{G}, in modo da garantire che tutti i membri del gruppo seguano le stesse regole e procedure per la verifica e validazione del prodotto
        ...
        \item \textbf{Automazione e Miglioramento dei Processi:} si occupa di automatizzare i processi, individuare punti di miglioramento nei processi e mettere in opera risorse per migliorare l'ambiente\textsuperscript{G} di lavoro
        \item \textbf{Gestione delle Infrastrutture:} si occupa di gestire l'infrastruttura e gli strumenti utilizzati, mantenere efficiente l'ambiente\textsuperscript{G} di sviluppo e fornire strumenti adeguati ai membri del gruppo e gestire errori e segnalazioni di malfunzionamenti con gli strumenti tecnologici
    \end{itemize}
\paragraph{Analista} 
    L'analista si occupa della raccolta\textsuperscript{G} e dell'analisi dei requisiti\textsuperscript{G}, interagendo con il proponente per chiarimenti.
    Le attività che l'analista svolge sono:
    \begin{itemize}
        \item \textbf{Raccolta\textsuperscript{G} Requisiti:} Interagire con l'azienda proponente per comprendere e documentare i requisiti funzionali e non funzionali del sistema e la loro importanza (obbbligatori, desiderabili, facoltativi)
        \item \textbf{Redazione Analisi dei Requisiti\textsuperscript{G}:} redigere il documento di analisi dei requisiti\textsuperscript{G}, valutandone la fattibilità e le implicazioni dei requisiti attraverso la stesura dei casi d'uso che li soddisfano
        ...
        \item \textbf{Redazione Glossario\textsuperscript{G}:} redigere e aggiornare il glossario\textsuperscript{G} del progetto, definendo i termini tecnici e le abbreviazioni utilizzate nel contesto del progetto
    \end{itemize}
\paragraph{Progettista}
Il progettista, partendo dai requisiti definiti nel documento di analisi dei requisiti\textsuperscript{G}, definisce il design architetturale del sistema.
    ...
    \begin{itemize}
        ...
        \item \textbf{Redazione Specifiche tecniche:} redigere il documento di specifiche tecniche in cui si riportano le scelte architetturali e tecnologiche (design pattern adottati, schema\textsuperscript{G} UML delle classi, tecnologie usate)
    \end{itemize}
...
Lo sviluppatore si occupa di sviluppare il software/implementa le funzionalità del software secondo le specifiche progettuali.
    ...
    \begin{itemize}
        ...
        \item \textbf{Documentazione\textsuperscript{G} del Codice:} mantenere una documentazione\textsuperscript{G} aggiornata del codice, per facilitarne la comprensione e la manutenzione
    \end{itemize}
...
Il verificatore si assicura che i documenti siano corretti, verifica il corretto funzionamento del software attraverso la scrittura di test e verifica della qualità del prodotto, assicurandosi che soddisfi i requisiti.
    ...
    \begin{itemize}
        ...
        \item \textbf{Verifica dei Documenti:} verifica i verbali delle riunioni interne ed esterne, il piano di progetto\textsuperscript{G} e il piano di qualifica\textsuperscript{G}
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Email}: utilizzata per inviare documenti ufficiali all'azienda proponente, come i verbali delle riunioni esterne e la documentazione\textsuperscript{G} di progetto
\end{itemize}
...
\begin{itemize}
    \item GitHub\textsuperscript{G}
    \item Git\textsuperscript{G}
    \item Visual Studio Code
    \item LaTeX\textsuperscript{G} Workshop
    \item Discord
    \item Slack
...
GitHub\textsuperscript{G} è una piattaforma di hosting per repository Git\textsuperscript{G} utilizzata per il versionamento del codice sorgente e della documentazione\textsuperscript{G} di progetto 
...
attraverso GitHub\textsuperscript{G} Actions\textsuperscript{G}, come per l'automazione del processo di compilazione della documentazione\textsuperscript{G} (tali workflow\textsuperscript{G} prelevano i file sorgenti 
in formato LaTeX\textsuperscript{G} dalla cartella source e generano i corrispondenti file PDF, che vengono collocati nella cartella principale del repository).\\
L'utilizzo di GitHub\textsuperscript{G} consente di garantire tracciabilità, collaborazione strutturata e integrazione continua.
\subsubsection{Git}
Git\textsuperscript{G} è un sistema di controllo di versione distribuito utilizzato per gestire le modifiche al codice sorgente e alla documentazione\textsuperscript{G}.\\
...
Visual Studio Code è l'ambiente\textsuperscript{G} di sviluppo integrato (IDE) principale adottato dal gruppo per lo sviluppo del codice sorgente e per la redazione della documentazione\textsuperscript{G} in LaTeX\textsuperscript{G}. \\
...
LaTeX\textsuperscript{G} Workshop è un'estensione di Visual Studio Code utilizzata per la compilazione, il controllo sintattico e l'anteprima dei documenti scritti in LaTeX\textsuperscript{G}. \\
L'uso di tale strumento consente di migliorare la qualità e l'affidabilità della documentazione\textsuperscript{G} prodotta.\\
Per l'uso di questa etensione è necessario prima installare:
\begin{itemize}
    \item \textbf{Distribuzione LaTex\textsuperscript{G} } installata localmente: TeX Live per sistemi Linux, MiKTeX per sistemi Windows, MacTeX per sistemi macOS\\
    Al suo interno devono essere disponibili:
    \begin{itemize}
        \item almeno un compilatore LaTeX\textsuperscript{G} (pdflatex, xelatex o lualatex);
...
Draw.io è utilizzato per la creazione di diagrammi dei casi d'uso e schemi UML a supporto della documentazione\textsuperscript{G} di progetto, facilitando la rappresentazione grafica e la comprensione delle soluzioni progettuali adottate.
...
Il momento principale di revisione avviene durante il momento di retrospettiva alla fine di ogni sprint\textsuperscript{G}, in cui si analizzano le difficoltà incontrate, le soluzioni adottate e si identificano possibili miglioramenti.\\
...
\begin{itemize}
    ...
    \item \textbf{Act (Azione):} viene deciso se adottare definitivamente le azioni implementate, modificarle ulteriormente o tornare alla fase di pianificazione per individuare nuove soluzioni
\end{itemize} 
...
\end{itemize}
Il processo di formazione è un processo continuo che si attiva ogni qualvolta venga introdotto nel progetto un nuovo strumento, processo o tecnologia. Tale processo si può suddividere nelle seguenti fasi:
\begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Backend} (9/12/2025): containers e docker\textsuperscript{G}, REST\textsuperscript{G}, NestJS\textsuperscript{G}
        \item \textbf{AWS\textsuperscript{G}} (16/12/2025): panoramica sui vari servizi offerti da AWS\textsuperscript{G}
        \item \textbf{Frontend} (17/12/2025): framework\textsuperscript{G} React\textsuperscript{G}, uso degli Hooks
        \item \textbf{Introduzione su AI} (18/12/2025): AI generativa, LLM\textsuperscript{G}, tecniche di prompting e customization, agenti (framework\textsuperscript{G} langchain\textsuperscript{G} o langgraph\textsuperscript{G}), demo
    \end{itemize}
    \item \textbf{studio individuale:} studiato individuale delle tecnologie proposte dall'azienda
    \item \textbf{creazione di un prototipo:} apprendimento delle tecnologie tramite la realizzazione di un prototipo più o meno complesso in cui principalmente si esplora l'utilizzo di agenti, il linguaggio TypeScript\textsuperscript{G}, il framework\textsuperscript{G} React\textsuperscript{G}
...
La \textbf{portabilità} si riferisce alla facilità con cui il software può essere trasferito da un ambiente\textsuperscript{G} a un altro.
In particolare descrive:
\begin{itemize}
    \item \textbf{Adattabilità}: la facilità con cui il software può essere adattato a nuovi ambienti o piattaforme.
    \item \textbf{Installabilità}: la facilità con cui il software può essere installato in un nuovo ambiente\textsuperscript{G}.
...
Di seguito sono elencate le metriche adottate dal gruppo, suddivise per tipologia di processo, con i relativi codici identificativi definiti nel Piano di Qualifica\textsuperscript{G}.
...
\begin{itemize}
    ...
    \item \textbf{Descrizione:} Indicatore della qualità formale della documentazione\textsuperscript{G}. L'obiettivo è mantenere questo valore a 0 per ogni documento rilasciato.
\end{itemize}

\subsubsection{Verifica}

\paragraph{Code Coverage\textsuperscript{G}}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Descrizione:} Percentuale di metriche di qualità che rispettano le soglie di accettabilità definite nel Piano di Qualifica\textsuperscript{G}.
\end{itemize}
...
\paragraph{Sprint\textsuperscript{G} Goal Achievement}
\begin{itemize}
    \item \textbf{Codice:} MPC-15 
    \item \textbf{Formula:} $$SGA = \frac{\text{Obiettivi raggiunti}}{\text{Obiettivi pianificati}} \times 100$$
    \item \textbf{Descrizione:} Misura la percentuale di obiettivi dello Sprint\textsuperscript{G} (Issue\textsuperscript{G} completate o milestone\textsuperscript{G} raggiunte) che sono stati soddisfatti al termine dell'iterazione rispetto a quelli pianificati.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Formula}: $\displaystyle \text{Requisiti obbligatori soddisfatti} = \frac{\text{Requisiti obbligatori soddisfatti}}{\text{Totale requisiti obbligatori}} \times 100$
    \item \textbf{Descrizione}: Questa metrica misura la percentuale di requisiti obbligatori che sono stati soddisfatti dal prodotto software rispetto al totale dei requisiti obbligatori definiti nell'analisi dei requisiti\textsuperscript{G}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Descrizione}: Questa metrica misura la percentuale di requisiti desiderabili che sono stati soddisfatti dal prodotto software rispetto al totale dei requisiti desiderabili definiti nell'analisi dei requisiti\textsuperscript{G}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Descrizione}: Questa metrica misura la percentuale di requisiti opzionali che sono stati soddisfatti dal prodotto software rispetto al totale dei requisiti opzionali definiti nell'analisi dei requisiti\textsuperscript{G}.
\end{itemize}
...
\subsection{Efficienza}
\subsubsection{Scan Response Time}
\begin{itemize}
    \item \textbf{Codice}: MPD05
    \item \textbf{Formula}: $\displaystyle \text{SRT} = \frac{\sum (T_{ready} - T_{trigger})}{n}$
    \item \textbf{Descrizione}: Questa metrica calcola l'intervallo temporale medio tra l'impulso di attivazione della scansione ($T_{trigger}$) e l'istante in cui il dato è processato e disponibile a sistema ($T_{ready}$).
\end{itemize}
