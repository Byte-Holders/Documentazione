...
\begin{longtable}[c]{ >{\centering\arraybackslash}m{2.5cm} >{\centering\arraybackslash}m{8.3cm} >{\centering\arraybackslash}m{3.5cm} }
    ...
    R-8-V-Ob & L'analisi di sicurezza deve basarsi sullo standard OWASP Top 10\textsuperscript{G} & Capitolato \\
    R-9-V-Ob & Architettura ad agenti coordinati da un orchestratore autocratico\textsuperscript{G} & Capitolato, \hyperref[UC17]{UC17} \\
\end{longtable}
