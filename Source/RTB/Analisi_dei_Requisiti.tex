...
\subsubsection{Attori di Frontend}
    \begin{itemize}
        ...
        \item \textbf{Utente autenticato}: rappresenta la generalizzazione di qualsiasi utente che ha effettuato l'accesso alla piattaforma, è l'attore base da cui ereditano tutti i ruoli specifici all'interno di un workspace
...
\subsubsection{Attori di Backend}
    \begin{itemize}
        ...
        \item \textbf{Timer}: attore temporale che attiva automaticamente casi d'uso periodici, come l'avvio di scansioni pianificate senza l'intervento diretto di un utente umano
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC5ext.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{../Assets/AdR/UC5.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{../Assets/AdR/UC6.png}
	\caption{UC6 e UC6.1}
	\label{fig:UC6}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC7.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC8.png}
	\caption{UC8 e UC8.1}
	\label{fig:UC8}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{../Assets/AdR/UC8-1.png}
	\caption{Inclusioni di UC8.1: UC6.1.1, UC6.1.2}
	\label{fig:UC8-1}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC9.png}
	\caption{UC9 e UC9.1}
	\label{fig:UC9}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC10ext.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC11.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC12.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC13.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC33-3.png}
	\caption{UC33.3 - Rimozione di un utente da un workspace}
	\label{fig:UC33-3}
\end{figure}
...
\subparagraph{UC33.3.1 - Visualizzazione analisi sicurezza semplice}\label{UC33.3.1}
\begin{itemize}
	\item \textbf{Attori principali:} Utente
	\item \textbf{Precondizioni:} 
    \begin{itemize}
...
\subparagraph{UC33.3.2 - Visualizzazione analisi sicurezza completa}\label{UC33.3.2}
\begin{itemize}
...
Il caso d'Uso UC33.3.2 include ulteriori casi d'uso come rappresentato nella seguente immagine:
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{../Assets/AdR/UC33-3-2.png}
	\caption{Inclusioni di UC33.3.2: UC33.3.2.1, UC33.3.2.2}
	\label{fig:UC33-3-2}
\end{figure}
...
\subparagraph{UC33.3.2.1 - Visualizzazione lista vulnerabilità riscontrate}\label{UC33.3.2.1}
\begin{itemize}
    \item \textbf{Attori principali:}
    \begin{itemize}
        \item Tech Lead
...
\subparagraph{UC33.3.2.2 - Approfondimento vulnerabilità}\label{UC33.3.2.2}
\begin{itemize}
    \item \textbf{Attori principali:} 
    \begin{itemize}
        \item Tech Lead
...
\paragraph{UC33.4 - Visualizzazione analisi documentazione} \label{UC33.4}



\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC33-4.png}
	\caption{UC33.4 - Visualizzazione analisi documentazione}
	\label{fig:UC33.4}
\end{figure}
...
\paragraph{UC33.5 - Visualizzazione qualità del codice} \label{UC33.5}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC33-5.png}
	\caption{UC33.5 - Visualizzazione qualità del codice}
	\label{fig:UC33-5}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{../Assets/AdR/UC34.png}
