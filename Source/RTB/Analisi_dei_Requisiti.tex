...
\begin{itemize}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../Assets/AdR/UC15ge.png}
	\caption{UC15 - Avvia scansione} 
...
\subsubsection{UC18 - PAT o URL non esistente}
\begin{itemize}
    \item \textbf{Attori principali:} Sistema, Orchestratore
    \item \textbf{Attori secondari:} GitHub
    \item \textbf{Precondizioni:}
        \begin{itemize}
            \item Il sistema è attivo e funzionante
    ...
    \item \textbf{Scenario Principale:}
        \begin{enumerate}
            \item Il sistema (o l'Orchestratore) invia una richiesta a GitHub per accedere alla repository utilizzando l'URL salvato e l'eventuale PAT associato
