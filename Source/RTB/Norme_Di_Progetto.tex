...
L'Amministratore si occupa di gestire e migliorare l'ambiente\textsuperscript{G} di lavoro, overro si occupa tenere aggiornati e migliorare l'infrastruttura tecnologica e organizzativa 
...
\paragraph{Analista} 
    ...
    \begin{itemize}
        ...
        \item \textbf{Redazione Analisi dei Requisiti\textsuperscript{G}:} redigere il documento di analisi dei requisiti\textsuperscript{G}, valutandone la fattibilità e le implicazione dei requisiti attraverso la stesura dei casi d'uso che li soddisfano
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Backend} (9/12/1015): containers e docker\textsuperscript{G}, REST\textsuperscript{G}, NestJS\textsuperscript{G}
...
\begin{itemize}
    ...
    \item \textbf{Formula}: $\displaystyle \text{Branch\textsuperscript{G} Coverage} = \frac{\text{Numero di rami eseguiti}}{\text{Totale numero di rami}} \times 100$
