...
Il verificatore si assicura che i documenti siano corretti, verifica il corretto funzionamento del software attraverso la scrittura di test e verifica della qualità del prodotto, assicurandosi che soddisfi i requisiti.
    ...
    \begin{itemize}
        ...
        \item \textbf{Verifica dei Documenti:} verifica i verbali delle riunioni interne ed esterne, il piano di progetto e il piano di qualifica
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Email}: utilizzata per inviare documenti ufficiali all'azienda proponente, come i verbali delle riunioni esterne e la documentazione di progetto
\end{itemize}
