...
\begin{center}
    ...
    \begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2cm} >{\raggedright\arraybackslash}m{2.5cm} >{\raggedright\arraybackslash}m{6.5cm}}
        ...
        1.0.0 & 09/03/2026 & Lorenzo Grolla & Approvazione del verbale \\
...
\begin{itemize}
    \item Raggruppare problemi simili in un'unica chiamata, riducendo il numero totale di richieste.
    \item Eseguire le interrogazioni in parallelo, sfruttando le funzionalità di LangGraph per lanciare istanze simultanee dei nodi.
\end{itemize}
